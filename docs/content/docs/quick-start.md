...
oscalkit has been packaged for various OS's and as a Docker image. Navigate to the [Releases](https://github.com/gocomply/oscalkit/releases) page to download the appropriate package for your intended platform.
...
Download the .exe from the [Releases](https://github.com/gocomply/oscalkit/releases) page. Move it to a location from which it can be easily executed.

#### Linux

Download the binary from the [Releases](https://github.com/gocomply/oscalkit/releases) page. Move it to a location from which it can be easily executed.
